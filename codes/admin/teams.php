...
$sql="INSERT INTO teams (team_name,team_abb,team_stadium,team_founded,team_coach,team_info,team_photo,team_logo,trophy)VALUE('$team','$abb','$stadium','$founded','$coach','$info','$photo','$logo','$trophy')";
...
{
$id=$_GET["delete"];
$sql="DELETE FROM teams WHERE team_code='$id'";
$query=mysqli_query($conn,$sql);
if($query)
{
	echo "Deleted";
...
{
	$photo=basename($_FILES['photo']['name']);
	$sql="UPDATE teams SET team_photo='$photo' WHERE team_code='$id'";
	$query=mysqli_query($conn,$sql);
	if($query)
	{
	}
...
if(move_uploaded_file($_FILES['logo']['tmp_name'], $path)) {
{
	...
	$logo=basename($_FILES['logo']['name']);
	$sql2="UPDATE teams SET team_logo='$logo' WHERE team_code='$id'";
...
$info=$_POST["info"];
$trophy=$_POST["trophy"];
$sql="UPDATE teams SET team_name='$team',team_abb='$abb',team_stadium='$stadium',trophy='$trophy',team_founded='$founded',team_coach='$coach',team_info='$info' WHERE team_code='$id'";
$query=mysqli_query($conn,$sql);
if($query)
{
	echo "UPDATEd";
...
<form enctype="multipart/form-data" action="teams.php" method="POST">
<div class="col-md-3">
<div class="section">
...
<div class="col-md-7">
<div class="section">
<input type="text" name="team" class="gui-input" placeholder="Ex. Erbil Footbal Club">
</div>
</div>
<div class="col-md-2">
<div class="section">
<input type="text" name="abb" class="gui-input" placeholder="Ex. EFC">
</div>
</div>

<div class="col-md-3">
<div class="section">
<label class="label">Stadium Name</label>
</div>
</div>
<div class="col-md-9">
<div class="section">
<input type="text" name="stadium" class="gui-input" placeholder="Ex. Franso Hariri Stadium">
</div>
</div>
<div class="col-md-3">
<div class="section">
...
<div class="col-md-9">
<div class="section">
<input type="text" name="founded" class="gui-input" placeholder="Ex. 1990">
</div>
</div>
...
<div class="col-md-9">
<div class="section">
<input type="text" name="coach" class="gui-input" placeholder="Ex. Name Name">
</div>
</div>

<div class="col-md-3">
<div class="section">
<label class="label">Team Information</label>
</div>
</div>
<div class="col-md-9">
<div class="section">
<textarea name="info" class="gui-input"></textarea>
</div>
</div>

<div class="col-md-3">
<div class="section">
<label class="label">Team Trophy</label>
</div>
</div>
<div class="col-md-9">
<div class="section">
<input type="number" name="trophy" class="gui-input"></textarea>
</div>
</div>

<div class="col-md-3">
<div class="section">
<label class="label">Team Photo</label>
</div>
</div>
<div class="col-md-9">
<div class="section">
...
$logo=$rowss["team_logo"];
$trophy=$rowss["trophy"];
$founded=$rowss["team_founded"];
}
?>
<div class="tray5">
<div class="tray-content">
...
<div class="col-md-7">
<div class="section">
<input type="text" name="team" class="gui-input" placeholder="Ex. Erbil Footbal Club" value="<?php echo $team; ?>">
</div>
</div>
<div class="col-md-2">
<div class="section">
<input type="text" name="abb" class="gui-input" placeholder="Ex. EFC" value="<?php echo $abb; ?>">
</div>
</div>
...
<div class="col-md-9">
<div class="section">
<input type="text" name="stadium" class="gui-input" placeholder="Ex. Franso Hariri Stadium" value="<?php echo $stadium; ?>">
</div>
</div>
<div class="col-md-3">
<div class="section">
...
<div class="col-md-9">
<div class="section">
<input type="text" name="founded" class="gui-input" placeholder="Ex. 1990" value="<?php echo $founded; ?>">
</div>
</div>
...
<div class="col-md-9">
<div class="section">
<input type="text" name="coach" class="gui-input" placeholder="Ex. Name Name" value="<?php echo $coach; ?>">
</div>
</div>
...
<div class="col-md-9">
<div class="section">
<textarea name="info" class="gui-input"><?php echo $info; ?></textarea>
</div>
</div>
<div class="col-md-3">
<div class="section">
...
<div class="col-md-9">
<div class="section">
<input type="number" name="trophy" class="gui-input" value="<?php echo $trophy; ?>"></textarea>
</div>
</div>
...
?>
<tr>
<td><?php echo $rowteam["team_code"]; ?></td>
<td><img src="../images/teams/logos/<?php echo $rowteam["team_logo"]; ?>" width="20"/></td>
<td><?php echo $rowteam["team_name"]; ?></td>
<td><?php echo $rowteam["team_stadium"]; ?></td>
<td><?php echo $rowteam["team_coach"]; ?></td>
<td><i class="fa fa-exclamation"></i></td>
<td>
<button class="btn btn-info btn-xs"><i class="fa fa-user"></i></button>
<a href="teams.php?edit=<?php echo $rowteam["team_code"];?>"><button class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></button></a>
<a href="teams.php?delete=<?php echo $rowteam["team_code"];?>" onclick="return  confirm('Confirm Deletion')"><button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button></a>
</td>
</tr>
<?php
}
