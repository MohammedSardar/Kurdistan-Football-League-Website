...
var Demo = function(options) {
    ...
    var runDemoSettings = function() {
        ...
        if (themeSettings.length) {
            ...
            // Create Theme Settings Button on load
            // Define Source code modal
            var settingsToggleBtn = '<div id="skin-toolbox-btn">' +
            ...
            // Append modal to body
            $(settingsToggleBtn).appendTo('body');
            $('#skin-toolbox-btn').on('click', function(e) {
                setTimeout(function() {
                    $('.settings-dropdown').find('.dropdown-toggle').dropdown('toggle');
                },50)
            });
            ...
            var settingsObj = {
                ...
                'headerSkin':       'navbar-gradient',
                'headerBtnSkin':    'navbar-gradient-btns',
                'headerDuoTone':    false,
