...
<div class="col-md-9">
<div class="section">
<input type="text" name="stadium" class="gui-input" placeholder="Ex. Muhammed Sardar">
</div>
</div>
...
<div class="col-md-9">
<div class="section">
<select name="city" class="gui-input">
<option>Erbil</option>
</select>
</div>
</div>
...
<div class="col-md-9">
<div class="section">
<input type="number" name="capacity" class="gui-input">
</div>
</div>
...
<tbody>
<?php
$sqlteam="SELECT * FROM stadiums";
$queryteam=mysqli_query($conn,$sqlteam);
while($rowteam=mysqli_fetch_array($queryteam))
{
?>
<tr>
<td><?php echo $rowteam["stadium_id"]; ?></td>
<td><?php echo $rowteam["stadium_name"]; ?></td>
<td><?php echo $rowteam["stadium_city"]; ?></td>
<td><?php echo $rowteam["stadium_capacity"]; ?></td>
<td>
